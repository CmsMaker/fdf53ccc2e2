...
<table border="0" cellspacing="15">
    ...
    <td width="140" style="font-size:12px" align="right">کلمه عبور قدیمی</td>
    	<td width="487" style="font-size:12px" align="right"><input name="old_password" type="password" class="user_change_pass" id="old_password" /></td>
    	
    </tr>
    <tr>
        	<td width="140" style="font-size:12px" align="right">کلمه عبور جدید</td>
    	<td width="487" style="font-size:12px" align="right"><input name="new_password" type="password" class="user_change_pass" id="new_password" /></td>
    </tr>
    <tr>
    <td width="140" style="font-size:12px" align="right">تکرار کلمه عبور جدید</td>
    	<td width="487" align="right"><input name="try_password" type="password" class="user_change_pass" id="try_password" /></td>
    	
    </tr>
    
    <tr>
    	<td width="140" align="center"><input name="b" type="submit" class="font" id="b" onClick="user_change_pass();" value="ثبت تغییرات" style="font-family:ST;font-size:15px" /></td>
