...
<div class="post_box_top">
  <div class="post_box_top_text">افزودن سوال متداول</div>
</div>
...
<table border="0" cellspacing="15">
    ...
    <td width="487" style="font-size:12px" align="right"><input name="title" type="text" id="title" size="80" style="font-family:tahoma;font-size:12px" /> 
        ...
        <tr>
    <td width="140" style="font-size:12px;">پاسخ سوال :</td>

    </tr>
    <tr><td width="487" style="font-size:12px" align="right"><textarea rows="3" name="text" id="text" class="xxlarge"></textarea>
    	</td></tr>
    <tr>
    	<td width="140" align="center"><input name="b" type="submit" class="font" id="b" onClick="faq_add();" value="ارسال سوال متداول" style="font-family:ST;font-size:15px" /></td>
    	<td width="487" align="right"><input name="Form" type="hidden" id="Form" value="faq_add" /> 
