...
<table width="435" border="0" cellspacing="15" dir="rtl" >
    ...
    <tr>
    <td width="487" style="font-size:12px" align="right"><input name="title" type="text" id="title" size="80" style="font-family:tahoma;font-size:12px" value="<?php echo $news['title'] ?>" /> 
</td>
    ...
    <tr><td width="487" style="font-size:12px" align="right"><textarea rows="3" name="text" id="text" class="xxlarge"><?php echo $news['text'] ?></textarea>
    	</td></tr>
    <tr>
    	<td width="140" align="center"><input name="b" type="submit" class="font" id="b" onClick="news_edit();" value="ویرایش خبر" style="font-family:ST;font-size:15px" />
<input name="Form" type="hidden" id="Form" value="news_edit" />
